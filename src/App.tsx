    ...
    <div className="min-h-screen bg-gray-100 flex items-center justify-center">
      <form onSubmit={handleSubmit} className="bg-white p-6 rounded shadow-md w-full max-w-2xl">
        ...
        <div className='flex justify-between my-5 py-5'>
          ...
          <span className='bg-blue-500 text-white px-4 py-2 rounded-sm'><a href='/src/assets/pdf/temario.pdf' target="_blank" rel="noopener noreferrer" download>Descargar Temario</a></span>
        </div>
